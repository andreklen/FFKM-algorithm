...
// Fuzzy K-means method
 ...
 while lwhi<=Voc1;
  ...
  MO=list('Mean orientatios: Dip/Direction for K= 2','Mean orientatios: Dip/Direction for K= 3','Mean orientatios: Dip/Direction for K= 3','Mean orientatios: Dip/Direction for K= 4','Mean orientatios: Dip/Direction for K= 5','Mean orientatios: Dip/Direction for K= 6','Mean orientatios: Dip/Direction for K= 7','Mean orientatios: Dip/Direction for K= 8')  
